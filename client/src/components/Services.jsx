...
const ServiceCard = ({color, title, icon, subTitle}) => (
  <div className="flex flex-row items-center w-30 p-7 justify-center white-glassmorphism m-2 cursor-pointer hover:shadow-xl">
    ...
    <div className="flex flex-col md:flex-row w-full justify-center items-center gradient-bg-services">
      <div className="flex mf:flex-row flex-col items-center justify-between md:p-20 p-12 px-4">
        <div className="flex flex-1 flex-col justify-start items-start">
          <h1 className="text-light text-3xl sm:text-5xl py-2 text-gradient">
            Services that we 
            <br/>
            continue to improve 
          </h1>
